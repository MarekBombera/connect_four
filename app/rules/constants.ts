const rulesContent = {
  ...
  3: 'The game ends when one player has four of their discs connected in a row. If all of the spaces on the board are filled without either player achieving four in a row, the game ends in a draw.',
